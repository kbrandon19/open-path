...
function introBanner() {
 ...
 <div className='w-full h-auto flex flex-center justify-center p-4 md:my-32 lg:px-16'>

  <div className=' mx-auto grid grid-cols-1 grid-rows-2 '>

    <div className='max-w-3xl '>
     <h1 className='text-3xl md:text-5xl lg:text-6xl font-semibold text-[#3E5B3A]'>
      Simplifying access to addiction treatment services.</h1>
      </div>
    
    <div className='max-w-xl  md:ml-64'>
