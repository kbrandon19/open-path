  ...
  return (
    ...
    <div className=' absolute w-full top-0 z-1 py-4 px-38 text-black '>
        ...
        <div className='flex w-auto h-auto flex-row gap-10 justify-between'> 
          ...
          {/* Desktop Menu */}
            <div className='hidden md:flex w-auto h-auto flex-row gap-4 items-center hidden text-sm'>
            ...
            <div className=' hidden md:flex px-4 py-2 w-auto h-auto rounded-full bg-[#E0B04E] flex flex-row items-center gap-2 text-sm'>
                Login
